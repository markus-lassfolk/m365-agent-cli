...
| `Tasks.Read.Shared` | Read Microsoft To Do lists/tasks shared with, or delegated to, the signed-in user (`todo --user`, `/users/{upn}/todo/...`) |
| `Tasks.ReadWrite.Shared` | Create/update/delete Microsoft To Do lists/tasks shared with, or delegated to, the signed-in user (`todo --user`, `/users/{upn}/todo/...`) |
